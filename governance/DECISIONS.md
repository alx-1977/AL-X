...
- **Amendment, 2026-08-30, approved by Friedl.** The first live reply sent without Friedl hearing the wording, and the ten minute expiry recorded above was never applied. Both are corrected, and the mechanism is recorded honestly here:
  ...
  - This is a property of the artifact, not a required sequence. AL/X needs no permission to ask a question, may draft, reconsider, or abandon a message in any order, and no goal status or lifecycle governs it. It exists so that what she reports sending is what actually left.
