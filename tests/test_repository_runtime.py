...
def answers(*, branch="main", status="", origin=SHA_B, fetch=0, merge=0):
    return {
        ("git", "rev-parse", "--show-toplevel"): [(0, str(ROOT))],
        ("git", "config", "--get", "remote.origin.url"): [(0, "git@github.com:owner/repo.git")],
        ("git", "symbolic-ref", "--quiet", "--short", "HEAD"): [(0, branch)],
        ("git", "rev-parse", "--verify", "HEAD^{commit}"): [(0, SHA_A), (0, SHA_B)],
        ("git", "rev-parse", "--verify", "refs/heads/main^{commit}"): [(0, SHA_A)],
        ("git", "status", "--porcelain=v1", "--untracked-files=all"): [(0, status)],
        ("git", "fetch", "origin", "refs/heads/main:refs/remotes/origin/main"): [(fetch, "")],
        ("git", "show-ref", "--verify", "--quiet", "refs/remotes/origin/main"): [(0, "")],
        ("git", "rev-parse", "--verify", "refs/remotes/origin/main^{commit}"): [(0, origin)],
